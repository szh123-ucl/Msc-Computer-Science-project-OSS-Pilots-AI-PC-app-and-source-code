...
template <> constexpr inline auto ComboBox::qt_create_metaobjectdata<qt_meta_tag_ZN8ComboBoxE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onFocusChanged'
        QtMocHelpers::SlotData<void(QWidget *, QWidget *)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
...
void ComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onFocusChanged((*reinterpret_cast< std::add_pointer_t<QWidget*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QWidget*>>(_a[2]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ComboBox::*)()>(_a, &ComboBox::focusIn, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ComboBox::*)()>(_a, &ComboBox::focusOut, 1))
            return;
    }
}
