/****************************************************************************
** Meta object code from reading C++ file 'storedimagesdialog.h'
**
...
#error "The header file 'storedimagesdialog.h' doesn't include <QObject>."
...
namespace {
struct qt_meta_tag_ZN18StoredImagesDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto StoredImagesDialog::qt_create_metaobjectdata<qt_meta_tag_ZN18StoredImagesDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QTreeWidgetItem *, int)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 11 }, { QMetaType::Int, 12 },
        }}),
    ...
    return QtMocHelpers::metaObjectData<StoredImagesDialog, qt_meta_tag_ZN18StoredImagesDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject StoredImagesDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<MasterDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18StoredImagesDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18StoredImagesDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18StoredImagesDialogE_t>.metaTypes,
    nullptr
} };

void StoredImagesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<StoredImagesDialog *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_fileTreeWidget_itemDoubleClicked((*reinterpret_cast< std::add_pointer_t<QTreeWidgetItem*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 5: _t->on_noteTreeWidget_itemDoubleClicked((*reinterpret_cast< std::add_pointer_t<QTreeWidgetItem*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 6: _t->on_refreshButton_clicked(); break;
        case 7: _t->on_fileTreeWidget_itemChanged((*reinterpret_cast< std::add_pointer_t<QTreeWidgetItem*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 8: _t->on_fileTreeWidget_customContextMenuRequested((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        case 9: _t->on_noteTreeWidget_customContextMenuRequested((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        case 10: _t->on_openFileButton_clicked(); break;
...
const QMetaObject *StoredImagesDialog::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *StoredImagesDialog::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18StoredImagesDialogE_t>.strings))
        return static_cast<void*>(this);
    return MasterDialog::qt_metacast(_clname);
}

int StoredImagesDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
